...
#ifndef INSTAGRAM_CLONE_SWIFT_H
#define INSTAGRAM_CLONE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Instagram_clone",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15Instagram_clone13SceneDelegate")
...
- (void)viewDidLoad;
- (IBAction)loginWithGooglePressed:(UIButton * _Nonnull)sender;
